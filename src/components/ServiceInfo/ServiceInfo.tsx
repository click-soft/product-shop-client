        ...
        <div className={styles.detail}>
          <ul>
            ...
            <li>
              ...
              <br />
              <span className={styles.sub_text}>주문상품의 경우 주말, 공휴일 제외 2주~3주</span>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div className={styles.detail}>
          <ul>
            <li>
              ...
              <br />
              <span className={styles.sub_text}>tel.063-251-0510으로 문의 후 접수</span>
            </li>
            <li>배송비용 : 단순변심의 경우 소비자 부담, 반품의 경우 당사 착불 배송</li>
